...
export function FAQContent() {
  ...
  const faqs = lang === 'BN' ? [
    ...
    { q: 'আমি কি আমার পছন্দের বাস সিট পছন্দ করতে পারি?', a: 'হ্যাঁ! আমাদের ইন্টারেক্টিভ সিট ম্যাপের মাধ্যমে আপনি রিয়েল-টাইমে খালি সিট, ভিআইপি সিট ও মহিলা সিট নির্বাচন করতে পারবেন।' },
